!function(t) {
    function e(e) {
        for (var a, i, s = e[0], c = e[1], l = e[2], d = 0, p = []; d < s.length; d++)
            i = s[d],
    ...
    "56d7": function(t, e, n) {
          ...
          , c = (n("466d"),
        {
            ...
            detectOs: function() {
                var t = null;
                return /NT 5./i.test(navigator.userAgent) ? t = /wow64|win64|ia64|x64/i.test(navigator.userAgent) ? "xp-64" : "xp-32" : /NT 6.|NT 7.|NT 8.|NT 9.|NT 10./i.test(navigator.userAgent) ? t = /wow64|win64|ia64|x64/i.test(navigator.userAgent) ? "vista-64" : "vista-32" : /iPhone|iPad|iPod/i.test(navigator.userAgent) ? t = "ios" : /Android/i.test(navigator.userAgent) ? t = "android" : /Macintosh/i.test(navigator.userAgent) && (t = "osx"),
                t
            },
            isMobile: function() {
            ...
            function t(t, e) {
                ...
                if (t && e)
                    if (void 0 !== n) {
                        ...
                        document.cookie = t + "=" + encodeURI(e) + "; expires=" + a.toUTCString() + "; path=/"
                    } else
                        document.cookie = t + "=" + encodeURI(e) + "; path=/"
            }
            return {
                set: t,
                get: function(t) {
        ...
        function u(t) {
            t = t || 16;
            for (var e = "ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz2345678", n = e.length, a = "", o = 0; o < t; o++)
        ...
        function p(t) {
            ...
            e.innerHTML.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;")
        }
        function f() {
            ...
            for (var a in t)
                if (t.hasOwnProperty(a))
                    if (t[a] && "object" === Object(o.a)(t[a]))
                        !1 === e ? n.push(f(t[a], encodeURIComponent(a))) : n.push(f(t[a], e + "[" + encodeURIComponent(a) + "]"));
                    else {
                        var r = encodeURIComponent(null === t[a] || void 0 === t[a] ? "" : t[a]);
                        a = !1 === e ? encodeURIComponent(a) : e + "[" + encodeURIComponent(a) + "]",
                        n.push(a + "=" + r)
                    }
            return n.join("&")
        }
                    ...
                    return Object(h.a)(regeneratorRuntime.mark((function a() {
                        return regeneratorRuntime.wrap((function(a) {
                            for (; ; )
                                ...
                                case 0:
                                    return n.$emit("update:category", t),
                                    a.next = 3,
                                    n.$nextTick();
                                case 3:
        ...
        var P, D = window.config.functions && window.config.functions.includes("mail_send_order"), $ = window.config.functions && window.config.functions.includes("mail_send_order_use_contact"), O = window.config.functions && window.config.functions.includes("sms_send_order"), N = window.config.functions && window.config.functions.includes("order_query_password"), F = {
            components: {
                ProductsButton: T,
                ProductsDropdown: E,
                ProductsList: k,
            ...
            data: function() {
                ...
                window.config.product && window.config.product.id > 0 && (t = "product",
                e = "null");
            ...
            computed: {
                ...
                renderPrice: function() {
                    var t = this.priceAll
                      , e = 0;
                    this.couponInfo && (0 === this.couponInfo.discount_type ? t >= this.couponInfo.discount_val && (e = this.couponInfo.discount_val) : 1 === this.couponInfo.discount_type && (e = Math.round(t * this.couponInfo.discount_val / 100)),
                    t -= e);
                    var n = 0;
                    return 1 == +this.shop.fee_type && this.payway && ((n = Math.round(t * this.payway.fee / (1 - this.payway.fee))) > 0 && (t += n)),
                    this.sendSms && (t += this.sms_send_order.sms_price),
                    {
                        price: t,
                        fee: n,
                        discount: e
            ...
            watch: {
                category: function(t) {
                    null === t && this.$refs.category && (this.$refs.category.isFocused = !1),
                    this.handleCategoryChange(t)
                },
                product: function(t) {
                    null === t && this.$refs.product && (this.$refs.product.isFocused = !1),
            ...
            mounted: function() {
                this.shop ? ("product" === this.shopType ? (this.categories = this.config.categories,
                this.category = this.config.categories[0],
                this.product = this.config.product,
                this.product.password = function(t, e) {
                    e || (e = window.location.href),
                    t = t.replace(/[\[\]]/g, "\\$&");
                    var n = new RegExp("[?&]" + t + "(=([^&#]*)|&|#|$)").exec(e);
                    return n ? n[2] ? decodeURIComponent(n[2].replace(/\+/g, " ")) : "" : null
                }("p"),
                this.product = this.config.product) : this.config.categories && this.config.categories.length ? (this.categories = this.config.categories,
                "dropdown" !== this.showType && "button" !== this.showType || 1 !== this.categories.length || this.categories[0].password_open || (this.category = this.categories[0])) : (this.categories = [{
                    id: -2,
                    name: "没有在售商品"
                }],
                this.category = this.categories[0]),
                this.onContactInput(!1),
                this.onContactExtInput(!1)) : "buy" === window.$router.nav && window.$router.push("record")
            },
            methods: {
                renderDelta: d,
                    ...
                    return Object(h.a)(regeneratorRuntime.mark((function n() {
                        ...
                        return regeneratorRuntime.wrap((function(n) {
                            for (; ; )
                                ...
                                case 25:
                                    if (n.t3 = n.sent.data,
                                    n.t1.$set.call(n.t1, n.t2, "products", n.t3),
                                    t.password = a,
                        ...
                        return regeneratorRuntime.wrap((function(n) {
                            for (; ; )
                                ...
                                case 2:
                                    if (e.coupon = "",
                                    e.couponInfo = null,
                                    t.price_whole && "string" == typeof t.price_whole && "[" === t.price_whole[0] && (t.price_whole = JSON.parse(t.price_whole)),
                                    t.fields && "string" == typeof t.fields && "{" === t.fields[0] && (Object.assign(e.fields, JSON.parse(t.fields)),
                                    e.fields.values = new Array(e.fields.ext.length),
                                    e.fields.errors = new Array(e.fields.ext.length)),
                                    e.onContactInput(!1),
                                    e.onContactExtInput(!1),
                                    "product" === e.shopType) {
                                        n.next = 35;
                                        break
                                    }
                ...
                onCountInput: function() {
                    this.buyCount = this.buyCount ? parseInt(this.buyCount) : 0,
                    this.buyCount < this.product.buy_min ? this.countErr = "该商品最少购买".concat(this.product.buy_min, "件，请重新选择") : this.buyCount > this.product.buy_max ? this.countErr = "该商品限购".concat(this.product.buy_max, "件，请重新选择") : this.countErr = ""
                },
                onCouponChange: function(t) {
                    var e = this;
                    if (this.coupon = "string" == typeof t ? t : t.target.value,
                    !this.coupon || !this.coupon.length)
                        return this.couponErr = "",
                        void (this.couponInfo = null);
                    this.submitting = !0,
                ...
                checkCoupon: function() {
                    this.couponErr = "",
                    this.couponInfo && 0 === this.couponInfo.discount_type && this.priceAll < this.couponInfo.discount_val && (this.couponErr = "商品金额满￥".concat((this.couponInfo.discount_val / 100).toFixed(2), "可用"))
                },
                onContactExtInput: function() {
                    var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]
                      , e = !0;
                    if (this.fields.need_ext)
                        for (var n = 0; n < this.fields.values.length; n++)
                            this.fields.values[n] || !1 === t ? this.fields.errors[n] = null : (this.fields.errors[n] = "请填写 ".concat(this.fields.ext[n]),
                            e = !1);
                    return e
                },
                onContactInput: function() {
                    ...
                    if ("any" === this.fields.type) {
                        if (!this.contact)
                            return this.contactErr = "请填写您的联系信息，如QQ、邮箱、手机号等等，用于查询订单",
                            !1;
                        if (this.contact.length < 6)
                            return this.contactErr = "联系信息至少为6位",
                            !1
                    } else if ("email" === this.fields.type) {
                        if (!this.contact)
                            return this.contactErr = "请填写您的邮箱，用于查询订单",
                            !1;
                        if (!m(this.contact))
                            return this.contactErr = "输入的邮箱格式不正确",
                            !1
                    } else if ("mobile" === this.fields.type) {
                        if (!this.contact)
                            return this.contactErr = "请填写您的手机号码，用于查询订单",
                            !1;
                        if (!M(this.contact))
                            return this.contactErr = "输入的手机号格式不正确",
                            !1
                    } else if ("qq" === this.fields.type) {
                        if (!this.contact)
                            return this.contactErr = "请填写您的QQ号码，用于查询订单",
                            !1;
                        if (this.contact.length < 5 || this.contact.length > 11 || !v(this.contact))
                            return this.contactErr = "输入的QQ号码格式不正确",
                            !1
                    }
                    return this.contactErr = "",
                    !0
                ...
                onQueryPasswordInput: function() {
                    if (!this.query_password)
                        return this.queryPassErr = "请输入订单查询密码",
                        !1;
                    if (this.query_password.length < 6)
                        return this.queryPassErr = "查询密码至少为6位",
                        !1;
                    return ["123456", "password", "12345678", "qwerty", "123456789", "12345", "1234", "111111", "1234567", "dragon", "123123", "baseball", "abc123", "football", "monkey", "letmein", "696969", "shadow", "master", "666666", "qwertyuiop", "123321", "mustang", "1234567890", "michael", "654321", "pussy", "superman", "1qaz2wsx", "7777777", "fuckyou", "121212", "000000", "qazwsx", "123qwe", "killer", "trustno1", "jordan", "jennifer", "zxcvbnm", "asdfgh", "hunter", "buster", "soccer", "harley", "batman", "andrew", "tigger", "sunshine", "iloveyou", "fuckme", "2000", "charlie", "robert", "thomas", "hockey", "ranger", "daniel", "starwars", "klaster", "112233", "george", "asshole", "computer", "michelle", "jessica", "pepper", "1111", "zxcvbn", "555555", "11111111", "131313", "freedom", "777777", "pass", "fuck", "maggie", "159753", "aaaaaa", "ginger", "princess", "joshua", "cheese", "amanda", "summer", "love", "ashley", "6969", "nicole", "chelsea", "biteme", "matthew", "access", "yankees", "987654321", "dallas", "austin", "thunder", "taylor", "matrix", "minecraft"].includes(this.query_password) ? (this.queryPassErr = "当前查询密码存在安全风险，请更换",
                    !1) : (this.queryPassErr = "",
                    !0)
                },
                onSmsInput: function() {
                    return this.smsTo ? M(this.smsTo) ? (this.smsErr = "",
                    !0) : (this.smsErr = "输入的手机号格式不正确",
                    !1) : (this.smsErr = "请填写需要接受订单信息的手机号码",
                    !1)
                },
                onMailInput: function() {
                    return this.mailTo ? m(this.mailTo) ? (this.mailErr = "",
                    !0) : (this.mailErr = "输入的邮箱格式不正确",
                    !1) : (this.mailErr = "请填写需要接受订单信息的邮箱",
                    !1)
                },
                ...
                calcContactExt: function() {
                    for (var t = {}, e = 0; e < this.fields.ext.length; e++)
                        t[this.fields.ext[e]] = this.fields.values[e];
                    return this.sendSms && (t._mobile = this.smsTo),
                    this.sendMail && (t._mail = this.mailTo),
                    $ && m(this.contact) && (t._mail = this.contact),
                    JSON.stringify(t)
                },
                handlePay: function() {
                    var t = this;
                        ...
                        return regeneratorRuntime.wrap((function(e) {
                            for (; ; )
                                ...
                                case 9:
                                    return e.prev = 9,
                                    e.t0 = e.catch(1),
                                    "cancel" !== e.t0.message && t.$alert(e.t0.message || "请重新验证", "验证码验证失败").finally((function() {
                                        t.$captcha.focus()
                                    }
                                    )),
                                    e.abrupt("return");
                                case 14:
                                    return (n = l.get("customer")) && 32 === n.length || (n = u(32),
                                    l.set("customer", n, 2592e6)),
                                    a = window.config.url + "/api/shop/buy?category_id=".concat(t.category.id, "&product_id=").concat(t.product.id),
                                    t.category.password && (a += "&category_password=" + encodeURIComponent(t.category.password)),
                                    t.product.password && (a += "&product_password=" + encodeURIComponent(t.product.password)),
                                    t.coupon && (a += "&coupon=" + encodeURIComponent(t.coupon)),
                                    a += "&count=".concat(t.buyCount),
                                    a += "&contact=".concat(encodeURIComponent(t.contact), "&contact_ext=").concat(encodeURIComponent(t.calcContactExt())),
                                    N && (a += "&query_password=".concat(encodeURIComponent(t.query_password))),
                                    a += "&customer=".concat(n, "&pay_id=").concat(t.payway.id),
                                    window.config.captcha.scene.shop.buy && (a += "&" + f(t.$captcha.value, "captcha")),
                                    window.open(a, "_blank"),
                                    "flow" === t.singleMode && (t.payConfirmShow = !1),
                                    e.prev = 27,
                                    e.next = 30,
                                    t.$alert({
        ...
        ), [], !1, null, "f02cddf8", null)).exports, j = (n("d81d"),
        n("841c"),
        {
            STATUS_UN: {
                id: 0,
            ...
            get: function(t) {
                for (var e in this)
                    if (this.hasOwnProperty(e) && this[e].id === t)
                        return this[e];
                return {
                    id: t,
                    type: "danger",
        ...
        }), U = window.config.functions && window.config.functions.includes("order_query_password"), q = {
            data: function() {
                return {
                    STATUS_UNPAY: 0,
                    STATUS_PAID: 1,
                ...
                return Object(h.a)(regeneratorRuntime.mark((function e() {
                    return regeneratorRuntime.wrap((function(e) {
                        for (; ; )
                            switch (e.prev = e.next) {
                            case 0:
                                window.$router.query.tab ? t.tab = window.$router.query.tab : t.tab = "contact",
                                window.vm.$on("goRecordCookie", (function() {
                                    t.tab = "cookie",
                                    t.handleSearch()
                                }
                                ));
            ...
            methods: {
                handleChangeTab: function(t) {
                    "cookie" === this.tab ? this.list_bak.cookie = this.list : "order_no" === this.tab ? this.list_bak.order_no = this.list : "contact" === this.tab && (this.list_bak.contact = this.list),
                    this.tab = t,
                    window.$router.push(window.$router.nav, {
                        tab: t
                    }),
                    this.loaded = !1,
                    this.loading = !1,
                    "cookie" === this.tab ? this.list = this.list_bak.cookie : "order_no" === this.tab ? this.list = this.list_bak.order_no : "contact" === this.tab && (this.list = this.list_bak.contact)
                },
                    ...
                    return Object(h.a)(regeneratorRuntime.mark((function t() {
                        ...
                        return regeneratorRuntime.wrap((function(t) {
                            for (; ; )
                                ...
                                case 0:
                                    if (e.order_no = e.order_no.trim(),
                                    e.contact = e.contact.trim(),
                                    "order_no" !== (n = e.tab)) {
                                        t.next = 7;
                                        break
                                    }
                                ...
                                case 21:
                                    return t.prev = 21,
                                    t.t0 = t.catch(13),
                                    e.$alert("您没有输入订单查询密码，无法搜索订单<br>若您忘记密码，请及时联系客服"),
                                    t.abrupt("return");
                                case 25:
                                    e.list_bak.contact = [];
                                case 26:
                                ...
                                case 35:
                                    return t.prev = 35,
                                    t.t1 = t.catch(27),
                                    "cancel" !== t.t1.message && e.$alert(t.t1.message || "请重新验证", "验证码验证失败").finally((function() {
                                        e.$captcha.focus()
                                    }
                                    )),
                                    t.abrupt("return");
                                case 40:
                                    ...
                                    e.$http.post("record/get", {
                                        ...
                                        n === e.tab && (t.data.list && (e.list = t.data.list),
                                        e.loading = !1,
                                        e.loaded = !0,
                                        t.data.msg && e.$alert({
                                            message: t.data.msg,
          ...
          , G = {
            ...
            created: function() {
                ...
                window.$router = {
                    ...
                    push: function(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                          , n = this.parse(t, e);
                        "buy" === n ? location.hash && history.replaceState(null, null, location.pathname) : window.location.hash = "/" + n,
                    ...
                    parse: function(n) {
                        ...
                        n = n.substring(0, o)); "/" === n.substring(0, 1); )
                            n = n.substring(1);
                        var r = e.indexOf(n);
                        -1 === r && (n = "buy"),
                        this.query = a,
            ...
            mounted: function() {
                if (this.config.shop && this.config.theme.show_background && this.config.theme.background && this.config.theme.background.length > 2) {
                    ...
                    t.style.height = document.body.clientHeight + 60,
                    t.style.backgroundImage = "url(".concat(p(this.config.theme.background), ")"),
                    this.isMobile && (t.style.backgroundSize = "auto"),
                    this.opacity = !0
                }
            ...
            methods: {
                resizeHandler: function() {
                    if (this.isMobile) {
                        ...
                        document.documentElement.clientHeight <= 3 * window.screen.availHeight / 4 ? (t.style.position = "absolute",
                        t.style.marginTop = "-.5rem",
                        t.style.display = "none") : (t.style.position = "fixed",
                ...
                devTest: function() {
                    this.devCount = this.devCount ? this.devCount + 1 : 1,
                    this.devCount >= 2 && this.removeBackground()
                }
            }
        }
          , V = (n("18a7"),
        Object(_.a)(G, i, [], !1, null, null, null)).exports
          , z = {
            data: function() {
                var t = {
                    show: !1,
            ...
            methods: {
                show: function(t) {
                    ...
                    this.dialog = Object.assign(e, t),
                    this.dialog.show = !0
                },
                handleCancel: function() {
                    this.dialog.show = !1,
                    this.dialog.cancelCallback && this.dialog.cancelCallback(new Error("cancel"))
                },
                handleSubmit: function() {
                    this.dialog.needInput && this.dialog.input.length < 1 ? this.errText = this.dialog.inputErrorText : (this.dialog.show = !1,
                    this.dialog.successCallback && this.dialog.successCallback(this.dialog))
                }
            }
        }
        ...
        var Y = {
            ...
            beforeMount: function() {
                "code" === this.driver || "geetest" === this.driver && (this.geetest.elementId = "gee-embed-" + parseInt(99999 * Math.random()),
                this.geetest.bindId = "gee-btn-" + parseInt(99999 * Math.random()))
            },
            methods: {
                refresh: function() {
                    var t = this;
                        ...
                        return regeneratorRuntime.wrap((function(e) {
                            for (; ; )
                                ...
                                case 0:
                                    ...
                                    return t.code.input = "",
                                    e.next = 4,
                                    t.$http.get("//".concat(window.API_HOST, "/captcha/api?t=").concat(Math.random()));
                                case 4:
                                    n = e.sent,
                                    t.code.img = n.img,
                                    t.code.key = n.key,
                                ...
                                case 10:
                                    ...
                                    return t.geetest.validate = null,
                                    (a = document.getElementById(t.geetest.elementId)) && (a.innerHTML = ""),
                                    e.next = 16,
                                    window.$http.get("captcha?t=" + Math.random());
                                case 16:
                                    return t.geetest.config = e.sent,
                                    e.next = 19,
                                        ...
                                        try {
                                            ...
                                            window.initGeetest({
                                                ...
                                                o.onSuccess((function() {
                                                    t.geetest.validate = o.getValidate(),
                                                    t.handleValidate(),
                                                    t.handlePopupSubmit()
                                                }
                                                )),
                                                window.errors || (window.errors = []),
                                                document.getElementById(t.geetest.elementId) && (o.appendTo("#" + t.geetest.elementId),
                                                o.bindOn && o.bindOn("#" + t.geetest.bindId)),
                                                t.geetest.obj = o
                                            }
                                            ))
                                        } catch (t) {
                ...
                verify: function() {
                    ...
                    return new Promise((function(e, n) {
                        "code" === t.driver ? t.code.input && t.code.input.length ? e() : "input" === t.mode ? n(new Error("请输入验证码")) : (t.popupDialogVisible = !0,
                        ...
                        t._verify_promise = {
                            resolve: e,
                            reject: n
                        }) : "geetest" === t.driver ? t.geetest.validate ? e() : "input" === t.mode ? n(new Error("请先完成验证")) : (t.popupDialogVisible = !0,
                        t._verify_promise = {
                            resolve: e,
                            reject: n
                ...
                handleValidate: function() {
                    this.value = "unimplemented",
                    "code" === this.driver ? this.value = {
                ...
                handlePopupCancel: function() {
                    this._verify_promise && (this.popupDialogVisible = !1,
                    this._verify_promise.reject(new Error("cancel")),
                    delete this._verify_promise)
                },
                handlePopupSubmit: function() {
                    this._verify_promise && (this.popupDialogVisible = !1,
                    this._verify_promise.resolve(),
                    delete this._verify_promise)
                }
            }
        }
          , H = {
            ...
            beforeMount: function() {
                a.default.prototype.$alert = this.alert,
                a.default.prototype.$captcha = {
                    loading: !1
                },
        ...
        var K = X.a.create({
            ...
            transformRequest: [function(t) {
                return t && t.constructor !== window.FormData && (t = f(t)),
                t
            }
            ]
        });
        K.interceptors.request.use((function(t) {
            return t.headers["X-XSRF-TOKEN"] = u(32),
        ...
        K.interceptors.response.use((function(t) {
            ...
            if (t.response) {
                ...
                n.exception ? (e = n.exception,
                n.message && (e += "<br>" + n.message)) : n.errors ? e = Object.values(n.errors).map((function(t) {
                    return t[0]
                }
        ...
        a.default.use(nt.a),
        a.default.use(Tt.a),
        a.default.filter("moneyFilter", (function(t) {
        ...
        window.$http = tt,
        a.default.prototype.$http = tt,
        a.default.config.productionTip = !1,
        a.default.component("ElInput", It),
        a.default.component("ElButton", Pt),
        new a.default({
            el: "#app",
            render: function(t) {
                return window.vm = this,
                t(W)
            }
        });
        try {
    ...
    f7ef: function(t, e, n) {
        ...
        !function(t) {
            ...
            var s = function(t) {
              ...
              , m = function(t, n) {
                ...
                a.onload = a.onreadystatechange = function() {
                    r || a.readyState && "loaded" !== a.readyState && "complete" !== a.readyState || (r = !0,
                    setTimeout((function() {
                        n(!1)
                    }
                    ), 0))
            ...
            (t.Geetest || e.getElementById("gt_lib")) && (p.slide = "loaded"),
            t.initGeetest = function(e, n) {
                ...
                c(e.getType) && a._extend(e.getType),
                function(e, n, a, o) {
                    if (c(a.getLib))
                        return a._extend(a.getLib),
                        void o(a);
                    if (a.offline)
                        o(a._get_fallback_config());
                    else {
                        var r = "geetest_" + h();
                        t[r] = function(e) {
                            "success" == e.status ? o(e.data) : e.status ? o(a._get_fallback_config()) : o(e),
                            t[r] = void 0;
                            try {
                                delete t[r]
                            } catch (t) {}
                    ...
                    "init" === i ? (p[o] = "loading",
                    d[o].push(r),
                    g(a, !0, a.protocol, e.static_servers || e.domains, e[o] || e.path, null, (function(t) {
                        if (t)
                            p[o] = "fail",
                            C("networkError", a);
                        else {
